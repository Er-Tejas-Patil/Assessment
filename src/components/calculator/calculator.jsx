  ...
  return (
    <div className="App">
      ...
      <div className='container'>
        ...
        <div>
          <button onClick={handleAddition} title='Add' data-testid='add'>+</button>
          <button onClick={handleSubstraction} title='Substract'><b>-</b></button>
          <button onClick={handleMultiplication} title='Multiply'><b>*</b></button>
        </div>
      </div>
    </div>
  );
